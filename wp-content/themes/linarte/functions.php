...
<?php
    ...
    wp_register_script('linarte-jquery', get_template_directory_uri() . '/js/linarte.js', array('jquery'), "2023.07.24.01", true);
...
{
    wp_register_style('estilo-principal', get_template_directory_uri() . '/style.css', array(), '2023.07.24.01', 'all');
