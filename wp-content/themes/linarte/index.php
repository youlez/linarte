            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-center">
                        <a class="reservar-inicio text-decoration-none fs-3" target="_blank" href="https://wa.me/+57<?php echo get_option('telefono_info'); ?>?text=<?php echo get_option('info_whatsapp'); ?>">RESERVA AHORA</a>
                    </div>
                </div>
            </div>
        </div>
