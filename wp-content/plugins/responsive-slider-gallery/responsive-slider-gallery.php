...
if ( ! class_exists( 'Responsive_Slider_Gallery' ) ) {
	...
	class Responsive_Slider_Gallery {
		...
		public function _rsgallery_menu() {
			$help_menu                = add_submenu_page( 'edit.php?post_type=' . RSG_PLUGIN_SLUG, __( 'Docs', 'responsive-slider-gallery' ), __( 'Docs', 'responsive-slider-gallery' ), 'administrator', 'rsgallery-doc-page', array( $this, '_rsgallery_doc_page' ) );
		...
		public function upload_multiple_images( $post ) {
			...
			<div name="add-new-slider" id="add-new-slider" class="new-slider" style="height: 210px; width: 220px; border-radius: 8px;">
				...
				<div class="add-text"><?php esc_html_e( 'New Slide', 'responsive-slider-gallery' ); ?></div>
			</div>
			<div style="clear:left;"></div>
			<br>
			<h1 style="font-size: xx-large;"><em><?php esc_html_e( 'Slider Settings', 'responsive-slider-gallery' ); ?></em></h1>
			<hr>
			<?php
